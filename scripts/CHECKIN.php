...
$longitude = mysqli_real_escape_string ( $connect ,$_POST['longitude']);
    ...
    $sql="INSERT INTO  exp_stasoft_check_in (record_date, ba_name, ba_phone, ba_region, latitude,longitude,t_date,t_time) 
    VALUES ('$date', '$ba_name', '$ba_phone', '$ba_region', '$latitude','$longitude', '$date', '$time')";
